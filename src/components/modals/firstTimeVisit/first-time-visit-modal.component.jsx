    ...
    return (
        <Fragment>
            ...
            <div className='flex-small-gap'>
                You can see the total amount of embers available to you when you click on the small
                <span className={`ember-counter-arrow-example main-hover`}>
                    <Arrow fill={getComputedStyle(document.body).getPropertyValue('--color-primary-accent')}/>
                </span>
            </div>
            <div>
